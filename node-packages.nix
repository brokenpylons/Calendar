...
let
  sources = {
    ...
    "puppeteer-core-12.0.1" = {
      ...
      version = "12.0.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/puppeteer-core/-/puppeteer-core-12.0.1.tgz";
        sha512 = "lty/1LQkl9zkMuQGwipHEBU8VD1m+SEWXG7zpdwzKet8P6L3taBNOt6Y1LpptakVejKz8TqMSjaWcEjqEKPfjw==";
      };
    };
    "qs-6.7.0" = {
      name = "qs";
